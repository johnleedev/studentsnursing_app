    ...
    if (data[1].notice === MainVersion || data[2].notice === MainVersion || data[3].notice === MainVersion) {
      ...
      Alert.alert(
          ...
          [
            ...
            { text: '업데이트', onPress: ()=>{
              if (Platform.OS === 'ios') {
                Linking.openURL('https://apps.apple.com/kr/app/%EA%B0%84%ED%98%B8%EB%8C%80%ED%95%99%EC%83%9D%EB%93%A4/id6477461773');
              } else {
                Linking.openURL('https://play.google.com/store/apps/details?id=com.studentsnursing.app');
              }
            }},
          ]
        );
